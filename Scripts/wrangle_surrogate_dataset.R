...
# rowbind model runs
runs <- list.files("./Output", full.names = TRUE)[1:1000]
...
write.csv(final, file = "./Output/surrogate-GLM-AED-runs_14AUG24.csv",row.names = FALSE)
